...
function saveConfig($maintenance, $default_title, $default_description, $default_keywords, $services_title, $services_description, $services_keywords, $portfolio_title, $portfolio_description, $portfolio_keywords, $contact_title, $contact_description, $contact_keywords, $footer)
{
