...
function saveConfig($default_title, $default_description, $default_keywords, $services_title, $services_description, $services_keywords, $portfolio_title, $portfolio_description, $portfolio_keywords, $contcat_title, $contact_description, $contact_keywords, $footer)
{
